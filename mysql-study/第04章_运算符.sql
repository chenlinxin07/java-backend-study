...
SELECT
  'a' = 'a',
  'ab' = 'ab',
  'a' = 'b' #两边都是字符串的话，则按照ANSI的比较规则进行比较。
FROM
  DUAL;
...
FROM
  ...
  #where salary = 6000;
WHERE
  commission_pct = NULL; #此时执行，不会有任何的结果
...
SELECT
  'shkstart' REGEXP '^shk',#这个是以什么开始
  'shkstart' REGEXP 't$',#这个是以怎么结尾
  'shkstart' REGEXP 'hk'
FROM
  DUAL;
SELECT
